...
with historical_tab:
    ...
    with key_obs_col2:
        ...
        risk_trend_data = db_util.get_risk_trend()
    ...
    with trend_tab2:
        compliance_trend_data = db_util.get_compliance_trend()
    ...
    with trend_tab4:
        severity_data = db_util.get_severity_distribution()
    ...
    with trend_tab5:
        category_data = db_util.get_category_distribution()
    ...
    if all_governance:
        ...
        for record in all_governance:
            ...
            risk_level_hist = record_governance_analysis.get('risk', 'unknown')
            escalation_hist = record_governance_analysis.get('escalation', 'N/A')
            
            # Truncate escalation for table display
            if len(escalation_hist) > 40:
                escalation_hist = escalation_hist[:37] + "..."
        ...
        for idx, record in enumerate(all_governance):
            ...
            risk_level_detail = record_governance_analysis.get('risk', 'unknown')
