...
def _apply_migration_v4(conn: sqlite3.Connection) -> None:
    ...
    This migration creates the insights_history table to store LLMGovernanceInsightsAgent
    ...
    cursor.execute("""
        INSERT INTO migrations (version, description)
        VALUES (?, ?)
    """, (4, "Add insights_history table for LLMGovernanceInsightsAgent outputs"))
...
def insert_insights_history(run_id: int, insights_json: dict, tarot_card: Optional[dict] = None) -> bool:
    ...
    This function stores the output from LLMGovernanceInsightsAgent
 for historical
    ...
    Args:
        ...
        insights_json: Dictionary containing governance insights data. This is the
                      full output from LLMGovernanceInsightsAgent
 and will be stored
